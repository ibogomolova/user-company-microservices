...
public class UserKafkaConfig {
    ...
    public ConsumerFactory<String, CompanyDeletedEventPayload> companyDeletedConsumerFactory() {
        ...
        jsonDeserializer.addTrustedPackages("*"); // принятие из любого пакета, без type headers

        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrap);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "user-service"); // общий groupId для инстансов user-service
    ...
    public ConcurrentKafkaListenerContainerFactory<String, CompanyDeletedEventPayload> companyDeletedKafkaListenerContainerFactory() {
        ...
        // обработка без авто-ack если хотите вручную подтверждать; по умолчанию Batch/Record ack не нужен
        return factory;
    }
}